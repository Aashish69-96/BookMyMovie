...
#include "../Routes/Auth/loginRoute.hpp"
#include "../Routes/Auth/signupRoute.hpp"
...
public:
    ...
    { // prefered than new avoids explicit memory management
        ...
        routes.push_back(std::make_unique<LoginRoute>());
        routes.push_back(std::make_unique<SignupRoute>());
    }
